...
exports.validateCreateBoard = [
    (0, express_validator_1.check)("board_title").notEmpty().isLength({ min: 1 }),
    handleError,
];
exports.validateCreateList = [
    (0, express_validator_1.check)("list_title").notEmpty().isLength({ min: 1 }),
    handleError,
];
exports.validateCreateItem = [
    (0, express_validator_1.check)("item_title").notEmpty().isLength({ min: 1 }),
    handleError,
];
